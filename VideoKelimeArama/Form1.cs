...
namespace VideoKelimeArama
{
    public partial class Form1 : Form
    {
        ...
        // Arama/dizin sınıfları (AramaSonucu, OcrKayit, OcrDizin,
        // KelimeEslestirici) Arama.cs dosyasındadır.
        ...
        private static string SureFormatla(double saniye) => Sure.Formatla(saniye);
        ...
        private static OcrDizin? DizinYukle(string videoYolu, string dizinYolu)
        {
            try
            {
                ...
                if (dizin == null || dizin.Surum != OcrDizin.GuncelSurum)
                {
                    return null;
                }
